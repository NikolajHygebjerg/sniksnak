      ...
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <Link
              href="/login"
              className="block w-full py-3 px-4 rounded-lg bg-[#FF8562] text-white font-medium hover:bg-[#FF7048] focus:outline-none focus:ring-2 focus:ring-[#FF8562] focus:ring-offset-2 transition-colors shadow-md"
            >
              Parent login
            </Link>
            <Link
